...
* rosecoin.conf: contains configuration settings for rosecoind or rosecoin-qt
* rosecoind.pid: stores the process id of rosecoind while running
...
* debug.log: contains debug information and general logging generated by rosecoind or rosecoin-qt
