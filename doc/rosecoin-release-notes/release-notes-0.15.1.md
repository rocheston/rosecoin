RoseCoin Core version *0.15.1* is now available from:

  <https://download.rosecoin.org/rosecoin-0.15.1/>
...
A number of changes to the way RoseCoin Core deals with peer connections and invalid blocks
