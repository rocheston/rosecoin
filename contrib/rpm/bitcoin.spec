...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 22123
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 22124
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 32123
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 32124
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 22123
	%{_sbindir}/semanage port -d -p tcp 22124
	%{_sbindir}/semanage port -d -p tcp 32123
	%{_sbindir}/semanage port -d -p tcp 32124
