...
const char * const BITCOIN_CONF_FILENAME = "rosecoin.conf";
const char * const BITCOIN_PID_FILENAME = "rosecoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RoseCoin";
#else
    // Unix
