...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rosecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rosecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rosecoin transaction") + "\n" +
              "  rosecoin-tx [options] -create [commands]   " + _("Create hex-encoded rosecoin transaction") + "\n" +
              "\n";
